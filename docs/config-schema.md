...
| `traceInfrastructureCorrelation` | no | bool | Whether to send host correlation properties to correlate traced services with the infrastructure (**default:** `"false"`) |
...
```yaml
  ...
  writer: 
    ...
    traceInfrastructureCorrelation: "false"
